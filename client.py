...
class GUI:
    ...
    def display_name_section(self):
        frame = Frame()
        Label(frame, text='Username:', font=("Verdana", 12)).pack(side='left', padx=15)
    ...
    def display_chat_box(self):
        frame = Frame()
        self.chat_transcript_area = Text(frame, width=60, height=10, font=("Verdana", 12))
    ...
    def display_chat_entry_box(self):
        frame = Frame()
        self.enter_text_widget = Text(frame, width=60, height=1, font=("Verdana", 12))
    ...
    def on_enter_key_pressed(self, event):
        if len(self.name_widget.get()) == 0:
            messagebox.showerror("Enter your name to send a message")
            return
        self.send_chat()
        self.clear_text()
